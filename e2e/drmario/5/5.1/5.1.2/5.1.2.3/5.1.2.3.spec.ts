...
test('5.1.2.3 HIGH speed scoring (300pts/virus)', async ({ page }) => {
  await page.goto('/');
  ...
  // Setup 1 virus (Yellow) and drop Yellow pill on it - HIGH speed
  await page.evaluate(() => {
  ...
  // 1 virus cleared at High speed = 300 points.
