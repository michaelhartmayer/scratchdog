...
test('5.1.2.5 Pill-only matches award 0 points', async ({ page }) => {
  await page.goto('/');
  ...
  // Setup pill-only match - LOW speed
  // (0,15) PILL_Y
  // (0,14) PILL_Y
  // (0,13) PILL_Y
  // Drop Y at (0,12) -> Match 4 vertical.
  // 0 Viruses cleared.
  // Points should be 0. (Maybe 0 even if chain? Spec says 5.1.2.5 matches award 0).
