...
test('5.1.2.2 MED speed scoring (200pts/virus)', async ({ page }) => {
  await page.goto('/');
  ...
  // Setup 1 virus (Yellow) and drop Yellow pill on it - MED speed
  await page.evaluate(() => {
  ...
  // 1 virus cleared at Med speed = 200 points.
