export default {
    meta: {
        type: 'problem',
        docs: {
            description: 'Disallow HTML button tags. Use DesignSystem components instead.',
            category: 'Best Practices',
            recommended: true,
        },
        schema: [],
        messages: {
            noHtmlButton: 'HTML <button> tags are not allowed. Use Button from DesignSystem instead.',
        },
    },
    create(context) {
