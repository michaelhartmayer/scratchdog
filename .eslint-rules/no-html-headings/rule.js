...
export default {
    meta: {
        type: 'problem',
        docs: {
            description: 'Disallow HTML heading tags. Use Text component from DesignSystem instead.',
            category: 'Best Practices',
            recommended: true,
        },
        schema: [],
        messages: {
            noHtmlHeading: 'HTML <{{ tag }}> tags are not allowed. Use Text from DesignSystem instead.',
        },
    },
    create(context) {
