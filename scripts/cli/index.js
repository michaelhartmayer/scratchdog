...
function displayGeneralHelp() {
    ...
    console.log('  list [folder]          Lists all *.spec.md files in the folder (defaults to "specifications")');
    console.log('  toc <file> [section]   Displays the table of contents for a spec file');
    console.log('  spec <file> [section]  Displays the specification for a file or section');
    console.log('  diff <file> [section]  Displays changes in a spec file since the last commit');
    console.log('  help                   Displays this help message');
    console.log('');
    console.log('Use "npm run specter <command> --help" for more information on a specific command.');
}
