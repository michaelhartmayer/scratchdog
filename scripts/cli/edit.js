...
export function editCommand(filePath, sectionNumber, newContent, options = {}) {
    if (options.help) {
        ...
        console.log('');
        console.log('Updates the content of the specified <section> in <file> with <content>.');
    ...
    if (!match) {
        ...
        console.error(`Error: Could not parse line ${section.lineIndex + 1}: ${originalLine}`);
        process.exit(1);
    }
