...
export class AudioManager {
    ...
    private _makeEnumerables() {
        Object.defineProperty(this, 'masterVolume', { get: () => this.get_masterVolume(), enumerable: true, configurable: true });
        Object.defineProperty(this, 'musicVolume', { get: () => this.get_musicVolume(), enumerable: true, configurable: true });
        Object.defineProperty(this, 'sfxVolume', { get: () => this.get_sfxVolume(), enumerable: true, configurable: true });
        Object.defineProperty(this, 'isMuted', { get: () => this.get_isMuted(), enumerable: true, configurable: true });
        Object.defineProperty(this, 'activeSounds', { get: () => this.get_activeSounds(), enumerable: true, configurable: true });
        Object.defineProperty(this, 'currentMusic', { get: () => this.get_currentMusic(), enumerable: true, configurable: true });
    }

    // Internal getters mapped by _makeEnumerables
    private get_masterVolume(): number { return this._masterVolume; }
    private get_musicVolume(): number { return this._musicVolume; }
    private get_sfxVolume(): number { return this._sfxVolume; }
    private get_isMuted(): boolean { return this._isMuted; }
    private get_activeSounds(): string[] { return Array.from(this._activeSFX); }
